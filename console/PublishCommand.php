...
class PublishCommand extends Command
{
    ...
    public function __construct(Filesystem $files)
    {
        ...
        $fromPath = __DIR__ . '/../../graphql';
        $this->fileMap = [
            $fromPath.'/config/config.php' => __DIR__.('../config/config.php'),
            $fromPath.'/resources/views/graphiql.php' => ('resources/views/vendor/graphql/graphiql.php')
        ];
    }
